...
░▒████▓  ▓█   ▓██▒░██▓ ▒██▒▒██▒ █▄   ▒██████▒▒░ ████▓▒░▒▒█████▓ ░██████▒▒██████▒▒     ▒██▒ ░ ░▒████▒▒██▒ ▒██▒  ▒██▒ ░    ░▒████▒░▒████▓ ░██░  ▒██▒ ░ ░██░░ ████▓▒░▒██░   ▓██░
 ...
 ░                                                                                                                               ░                                           
	...
	platform211 = ("The building is tall and has arches for doorways. Inside the room you see a pair of the giant Knights across the room from each other. There is a \x1B[3cchest\x1B[0m that the two are gaurding. To the West you see an exit to the building")
...
·▀▀▀▀  ▀█▄▀▪▀▀ █▪▀▀▀ ▀▀▀.▀  ▀ ▀▀▀     .▀▀▀ ▀▀▀ ▀▀▀ 
			...
			print(f"{player_position}")
		elif player_input == "north" and player_position == platform31os:
			player_position = platform310
			print(f"{player_position}")
		elif player_input == "south" and player_position == platform310:
			player_position = platform310s
			print(f"{player_position}")
		elif player_input == "east" and player_position == platform310:
			player_position = 300
			print(f"{player_position}")
		else:
